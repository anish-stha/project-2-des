...
class DesEncryption {
    ...
    public static void main(String args[]) {
        ...
        DES cipher = new DES();
        while (true) {
            System.out.print("Press 1 for encryption and press 2 for decryption");
            int option  = scanner.nextInt();
            scanner.nextLine();
            if (option == 1) {
                System.out.println("Enter 64 bit plaintext in Hex:");
                String plainText = scanner.nextLine();
                System.out.println("Enter your 64 bit key in Hex:");
                ...
                System.out.println("Enter 64 bit  ciphertext in Hex:");
